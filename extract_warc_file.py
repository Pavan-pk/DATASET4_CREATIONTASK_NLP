            ...
            for image_tag in ol.find_all('img'):
                if image_tag['alt'] != "":
                    try:
                        ...
                        if not ('.jpeg' in image_filename.lower() or
                                '.png' in image_filename.lower() or
                                '.jpg' in image_filename.lower()):
                            continue
...
def main():
    ...
    write_header = True
    if os.path.exists("dataset4_task.csv"):
        write_header = False
